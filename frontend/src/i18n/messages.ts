...
export const en = {
  common: {
    ...
    campusErrors: {
      ...
      codes: {
        ...
        CREDIT_CAP_EXCEEDED: 'Registering this course would exceed the credit cap for the term.',
  ...
  thesis: {
    ...
    addMemberModalDescription:
      'Add an internal student by Student ID or an external member from another department / university.',
    ...
    proposeTopicDescription:
      'Enter the topic details below. You can choose to publish it immediately or keep it as draft.',
    ...
    supervisedGroupsDescription:
      'Review and approve or reject groups registered for your topics.',
...
export const vi: I18nMessages = {
  common: {
    ...
    campusErrors: {
      ...
      codes: {
        ...
        CREDIT_CAP_EXCEEDED: 'Đăng ký học phần này sẽ vượt giới hạn tín chỉ của học kỳ.',
  ...
  thesis: {
    ...
    addMemberModalDescription:
      'Thêm sinh viên cùng trường theo MSSV hoặc thành viên ngoài trường, khác khoa / ngành.',
    ...
    proposeTopicDescription:
      'Nhập thông tin đề tài bên dưới. Bạn có thể công bố ngay hoặc lưu dưới dạng bản nháp.',
    ...
    supervisedGroupsDescription:
      'Xét duyệt hoặc từ chối các nhóm sinh viên đăng ký đề tài do bạn hướng dẫn.',
