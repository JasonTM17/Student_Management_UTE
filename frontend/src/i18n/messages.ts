...
export const en = {
  ...
  verifyEmail: {
    ...
    verificationUnavailable: 'Verification is temporarily unavailable. Your link has not been consumed. Try again in a moment.',
...
export const vi: I18nMessages = {
  ...
  verifyEmail: {
    ...
    verificationUnavailable: 'Dịch vụ xác minh tạm thời chưa sẵn sàng. Liên kết của bạn chưa bị sử dụng. Hãy thử lại sau.',
