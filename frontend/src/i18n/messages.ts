...
export const en = {
  ...
  courseRegistration: {
    ...
    roundUnavailableDescription: 'Come back when the registrar opens the registration or add/drop window for your semester.',
    ...
    searchLabel: 'Search sections by code or name',
    filterAll: 'All',
    filterMandatory: 'In curriculum',
    filterElective: 'Elective',
    filterOutside: 'Outside curriculum',
    outsideBadge: 'Outside curriculum',
    filterSeats: 'Seats open',
    filterNoConflict: 'No schedule conflict',
    sortLabel: 'Sort sections',
    sortCode: 'Course code',
    sortCredits: 'Credits',
    sortSeats: 'Open seats',
    scheduleNone: 'No schedule yet',
    scheduleChipRoom: 'Room {room}',
    scheduleChipLecturer: 'Lect. {name}',
    roundCountdownPrefix: 'Time left',
    roundCountdownDays: '{days}d',
    roundClosedBadge: 'Closed',
    roundWindowHint: '{start} to {end}',
    creditLimitUnavailable: '—',
    ...
    miniTimetableTitle: 'Weekly timetable preview',
    legendRegistered: 'Registered',
    legendPreview: 'Preview',
    legendConflict: 'Conflict',
    limitPolicyShow: 'Show credit-limit policy and request form',
    limitPolicyHide: 'Hide credit-limit policy',
    errorCodes: {
      sectionFull: 'This class is full.',
      scheduleConflict: 'Conflicts with a class you already registered.',
      creditCapExceeded: 'Exceeds the approved credit limit.',
      prerequisiteUnmet: 'You have not completed the prerequisite course yet.',
      corequisiteUnmet: 'Register the prior/parallel co-requisite course together with this one.',
      windowClosed: 'The registration window has closed.',
      cohortIneligible: 'You are not in the audience for this registration round.',
      idempotencyRetry: 'Your previous request is still being processed — try again shortly.',
    },
    columns: {
      course: 'Course',
      section: 'Section',
  ...
  admin: {
    ...
    menuItems: [
      ...
      ['System notifications', 'Broadcast a targeted notification into one user inbox.'],
      ['Attendance', 'Review attendance records marked across all class sections.'],
    ],
    ...
    analytics: {
      ...
      departments: {
        AIDS: 'AI & Data Science Department',
        AUTO: 'Automation & Control Engineering',
        'AUTO-ENG': 'Automotive & Engine Engineering',
        BIMENG: 'Digital Construction & BIM Department',
        BTE: 'Business English',
        CIVIL: 'Civil Engineering',
        CNTT: 'Faculty of Information Technology',
        ETEC: 'Electronics, Telecom & IoT',
        FIN: 'Banking & FinTech Faculty',
        ISBD: 'Information Systems & Big Data',
        LSCM: 'Logistics & Supply Chain',
        MANUF: 'Manufacturing & CNC Engineering',
        MIS: 'Management Information Systems & E-commerce',
        NETSEC: 'Computer Networks & Security',
        ROBOT: 'Mechatronics & Robotics',
      ...
      atLeastGoodLabel: 'Graded results in the top bands (A+, A, A−, B+):',
    },
    appearance: {
    ...
    // Admin users console: strings explaining fields the account-issuance DTO
    // cannot carry. The console renders its copy inline, so these mirror it.
    users: {
    ...
    notifications: {
      ...
      description:
        'Send a notification straight into one user inbox. It appears in the recipient bell across the whole CampusUTE platform.',
      recipientLabel: 'Recipient',
      recipientHint: 'Identified through the campus account database.',
      recipientSearchPlaceholder: 'Search by email or name…',
      recipientSearchLabel: 'Find a recipient',
      recipientSearchFailed: 'The account directory could not be searched right now.',
      recipientNoMatch: 'No account matches this search.',
      recipientResultsLabel: 'Search results',
      recipientRemove: 'Remove recipient',
      recipientSingleOnly:
        'Each notification goes to exactly one user. For campus-wide notices, use the announcement system.',
      ...
      typeError: 'Urgent',
      titleLabel: 'Title',
      titlePlaceholder: 'Write a short, clear headline…',
      messageLabel: 'Message',
      messagePlaceholder: 'Describe what the recipient needs to know…',
      linkLabel: 'Related link',
      linkOptional: '(optional)',
      linkPlaceholder: '/dashboard/…',
      linkHint: 'An internal CampusUTE path the recipient can open directly.',
      linkInvalid: 'The link must start with “/”.',
      previewLabel: 'Bell preview',
      previewHint: 'How the row appears in the recipient inbox.',
      previewJustNow: 'Just now',
      previewNoTitle: '(no title yet)',
      previewNoMessage: '(no message yet)',
      previewSentBy: 'Sent by',
      auditHint: 'Every notification sent from here is recorded in the system history.',
      clearDraft: 'Clear draft',
      send: 'Broadcast',
      sending: 'Sending…',
      validationIncomplete: 'Fill in the recipient, title, and message.',
      sentSuccess: 'Notification sent to {name}.',
      sentFailed: 'The notification could not be sent. Please try again.',
      sentTitle: 'Sent',
      sentDescription: 'System notifications already broadcast, newest first.',
      sentLoading: 'Loading sent notifications',
      sentLoadFailed: 'Sent notifications could not be loaded.',
      sentEmptyTitle: 'Nothing broadcast yet',
      sentEmptyDescription:
        'Notifications you send from this page will be listed here.',
      sentHeaders: {
        title: 'Title',
        type: 'Type',
        recipient: 'Recipient',
      ...
      sentPageSummary: '{count} notification(s)',
      previousPage: 'Previous',
      nextPage: 'Next',
      deleteLabel: 'Delete notification',
      deleteConfirmTitle: 'Delete this notification?',
      deleteConfirmMessage:
        'It disappears from the recipient inbox as well. This cannot be undone.',
      ...
      roles: {
        ...
        TRUONG_KHOA: 'Faculty head',
      },
    },
    attendance: {
      title: 'Attendance',
      description:
        'Every attendance record marked across class sections, newest pages first.',
      loading: 'Loading attendance records',
      unavailableTitle: 'Attendance unavailable',
      errorDescription: 'Attendance records could not be loaded. Check your connection and try again.',
      emptyTitle: 'No attendance records',
      emptyDescription:
        'Records appear here as soon as lecturers mark sessions for their sections.',
      refresh: 'Refresh',
  ...
  // LEC-P3-B2: discard confirm for the lecturer student-notice composer.
  lecturerAnnouncementDraft: {
    discardTitle: 'Discard this announcement draft?',
    discardMessage:
      'This notice has not been published yet. Closing now discards everything typed in the composer.',
  ...
  thesis: {
    ...
    memberSearchPlaceholder: 'Student ID or full name',
    ...
    maxMembersReached: 'The maximum group size is 4 members.',
    ...
    progressDescription: 'Follow evidence-backed milestones for your selected round.',
    progressCurrentStage: 'Current stage',
    progressGroupRequired: 'Create or join a group to see group-specific progress.',
    progressAttention: 'Attention needed',
    progressNotParticipating: 'You do not have a group in this round. This history is not marked as completed.',
    progressResultNotAvailable: 'The round is published, but your personal result is not available yet.',
    progressDataIntegrity: 'This group must have 3 to 4 members. Add members and wait for administrative review before progress can continue.',
    progressInconsistent: 'Some later records exist without their required prerequisite. The official progress stops at the last verified milestone; thesis staff should review the record.',
    progressGroupRejected: 'Your group was rejected. Review the reason with the thesis office.',
    progressGroupCancelled: 'Your group was cancelled and no longer advances this round.',
    progressReportedStatus: 'Self-reported status',
    progressSteps: [
      'Round selected',
      'Group created',
      'Topic assigned',
    ...
    councils: {
      ...
      lecturerLoadFailed: 'The lecturer roster could not be loaded, so the member picker is empty.',
      roleChair: 'Chair',
    ...
    admin: {
      ...
      topicsForRound: '{round}: Topics',
      groupsForRound: '{round}: Groups',
    },
  },
  assistant: {
    ...
    feedbackSaveFailed: 'Feedback was not saved. Your last saved selection is unchanged.',
  ...
  roundMilestone: {
    ...
    phase2Desc: 'Groups of 3–4 students pick one topic (Reg. R4)',
  ...
  attendance: {
    ...
    title: 'Attendance',
    description:
      'Attendance your lecturers have recorded: per-course totals first, then your most recent sessions.',
    loading: 'Loading attendance',
    unavailableTitle: 'Attendance unavailable',
    errorDescription: 'Attendance could not be loaded. Check your connection and try again.',
    emptyTitle: 'No attendance records yet',
    emptyDescription:
      'Once lecturers start marking attendance for your classes, the per-course totals and session history will appear here.',
    statsPresentRate: 'Present rate',
    statsPresentRateHint: 'present sessions ÷ recorded sessions',
    statsTotalSessions: 'Recorded sessions',
    statsPresent: 'Present',
    statsAbsentLate: 'Absent + late',
    byCourseTitle: 'Attendance by course',
    byCourseEyebrow: 'Per class section',
    recentTitle: 'Recent sessions',
    recentEyebrow: 'Session log',
    recentEmpty: 'No individual sessions recorded yet.',
    showingRecent: 'Showing {count} of {total} recorded sessions',
    tableHeaders: {
      course: 'Course',
      sessions: 'Sessions',
      present: 'Present',
  ...
  lecturerAttendance: {
    eyebrow: 'Teaching area',
    title: 'Attendance Management',
    description: 'Track and mark student attendance by class section and date.',
    ...
    savingButton: 'Saving...',
    savedSuccess: 'Attendance recorded successfully for {count} students',
    saveFailed: 'Failed to record attendance. Please try again.',
    noSectionsTitle: 'No classes assigned',
    noSectionsDescription: 'You are not currently assigned to teach any class sections.',
    noStudentsTitle: 'No students enrolled',
    noStudentsDescription: 'There are currently no active students enrolled in this section.',
    loadingSections: 'Loading class sections...',
    loadingRoster: 'Loading student roster...',
    columnStudent: 'Student',
    columnStudentCode: 'Student code',
    columnStatus: 'Attendance status',
    columnNotes: 'Notes',
    notesPlaceholder: 'Reason or notes (optional)',
    statsTotalStudents: 'Enrolled students',
    statsMarked: 'Marked today',
    statsPresentRate: 'Class present rate',
    statuses: {
      PRESENT: 'Present',
      ABSENT: 'Absent',
      LATE: 'Late',
...
export const vi: I18nMessages = {
  ...
  courseRegistration: {
    ...
    roundUnavailableDescription: 'Vui lòng quay lại khi Phòng Đào tạo mở cửa sổ đăng ký hoặc đăng ký/huỷ môn cho học kỳ của bạn.',
    ...
    searchLabel: 'Tìm lớp học phần theo mã hoặc tên',
    filterAll: 'Tất cả',
    filterMandatory: 'Trong chương trình',
    filterElective: 'Tự chọn',
    filterOutside: 'Ngoài chương trình',
    outsideBadge: 'Ngoài chương trình',
    filterSeats: 'Còn chỗ',
    filterNoConflict: 'Không trùng lịch',
    sortLabel: 'Sắp xếp lớp học phần',
    sortCode: 'Mã môn',
    sortCredits: 'Tín chỉ',
    sortSeats: 'Chỗ trống',
    scheduleNone: 'Chưa có lịch',
    scheduleChipRoom: 'Phòng {room}',
    scheduleChipLecturer: 'GV {name}',
    roundCountdownPrefix: 'Còn lại',
    roundCountdownDays: '{days} ngày',
    roundClosedBadge: 'Đã đóng',
    roundWindowHint: 'Từ {start} đến {end}',
    creditLimitUnavailable: '—',
    ...
    miniTimetableTitle: 'Xem trước thời khóa biểu tuần',
    legendRegistered: 'Đã đăng ký',
    legendPreview: 'Xem trước',
    legendConflict: 'Trùng lịch',
    limitPolicyShow: 'Xem quy định hạn mức và đơn xin vượt hạn mức',
    limitPolicyHide: 'Thu gọn quy định hạn mức',
    errorCodes: {
      sectionFull: 'Lớp đã đầy.',
      scheduleConflict: 'Trùng lịch với lớp đã đăng ký.',
      creditCapExceeded: 'Vượt hạn mức tín chỉ cho phép.',
      prerequisiteUnmet: 'Chưa hoàn thành học phần tiên quyết.',
      corequisiteUnmet: 'Cần đăng ký kèm học phần học trước/song song.',
      windowClosed: 'Đã hết thời gian đăng ký.',
      cohortIneligible: 'Bạn không thuộc đối tượng của đợt đăng ký này.',
      idempotencyRetry: 'Yêu cầu trước của bạn đang được xử lý — vui lòng thử lại sau giây lát.',
    },
    columns: {
      course: 'Học phần',
  ...
  admin: {
    ...
    menuItems: [
      ...
      ['Thông báo hệ thống', 'Phát thông báo đích danh tới hộp thư của một người dùng.'],
      ['Điểm danh', 'Xem lại các bản ghi điểm danh của toàn bộ lớp học phần.'],
    ],
    creditLimitApplications: {
    ...
    analytics: {
      ...
      departments: {
        AIDS: 'Bộ môn Trí tuệ Nhân tạo & KH Dữ liệu',
        AUTO: 'Kỹ thuật Tự động hóa',
        'AUTO-ENG': 'Kỹ thuật Ô tô & Động lực',
        BIMENG: 'Kỹ thuật Xây dựng số & BIM',
        BTE: 'Tiếng Anh Thương mại',
        CIVIL: 'Kỹ thuật Xây dựng',
        CNTT: 'Khoa Công nghệ Thông tin',
        ETEC: 'Điện tử Viễn thông & IoT',
        FIN: 'Ngân hàng & FinTech',
        ISBD: 'Hệ thống Thông tin & Dữ liệu lớn',
        LSCM: 'Logistics & Chuỗi cung ứng',
        MANUF: 'Kỹ thuật Chế tạo máy & CNC',
        MIS: 'HTTT Quản lý & TMĐT',
        NETSEC: 'Mạng máy tính & An toàn thông tin',
        ROBOT: 'Cơ điện tử & Kỹ thuật Robot',
      ...
      atLeastGoodLabel: 'Kết quả có điểm chữ thuộc nhóm cao (A+, A, A−, B+):',
    },
    appearance: {
      title: 'Diện mạo cổng',
      description:
    ...
    users: {
      academicTitleManagedHint:
        'Tạo tài khoản nhanh chỉ lưu bộ môn công tác; học hàm / học vị do Phòng Đào tạo cập nhật trong danh bạ Giảng viên.',
      facultyManagedHint:
    ...
    notifications: {
      ...
      description:
        'Gửi thông báo trực tiếp vào hộp thư của một người dùng. Thông báo xuất hiện ngay trên chuông của người nhận trong toàn bộ nền tảng CampusUTE.',
      recipientLabel: 'Người nhận',
      recipientHint: 'Định danh qua cơ sở dữ liệu tài khoản nhà trường.',
      recipientSearchPlaceholder: 'Tìm theo email hoặc tên…',
      recipientSearchLabel: 'Tìm người nhận',
      recipientSearchFailed: 'Hiện chưa thể tra cứu danh bạ tài khoản.',
      recipientNoMatch: 'Không tìm thấy tài khoản phù hợp.',
      recipientResultsLabel: 'Kết quả tìm kiếm',
      recipientRemove: 'Xoá người nhận',
      recipientSingleOnly:
        'Mỗi lần phát chỉ gửi tới đúng một người dùng. Để thông báo toàn trường, hãy dùng hệ thống đăng thông báo.',
      ...
      typeError: 'Khẩn cấp',
      titleLabel: 'Tiêu đề',
      titlePlaceholder: 'Nhập tiêu đề ngắn gọn, rõ ràng…',
      messageLabel: 'Nội dung',
      messagePlaceholder: 'Mô tả chi tiết nội dung cần thông báo cho người nhận…',
      linkLabel: 'Liên kết kèm theo',
      linkOptional: '(không bắt buộc)',
      linkPlaceholder: '/dashboard/…',
      linkHint: 'Đường dẫn nội bộ trong cổng CampusUTE để người nhận mở trực tiếp.',
      linkInvalid: 'Đường dẫn phải bắt đầu bằng “/”.',
      previewLabel: 'Xem trước trên chuông thông báo',
      previewHint: 'Mô phỏng hộp thư mà người nhận nhìn thấy.',
      previewJustNow: 'Vừa xong',
      previewNoTitle: '(chưa có tiêu đề)',
      previewNoMessage: '(chưa có nội dung)',
      previewSentBy: 'Phát bởi',
      auditHint: 'Mọi thông báo phát từ đây đều được ghi vào lịch sử hệ thống.',
      clearDraft: 'Xoá nháp',
      send: 'Phát thông báo',
      sending: 'Đang phát…',
      validationIncomplete: 'Điền đủ người nhận, tiêu đề và nội dung.',
      sentSuccess: 'Đã phát thông báo đến {name}',
      sentFailed: 'Không phát được thông báo. Vui lòng thử lại.',
      sentTitle: 'Đã phát',
      sentDescription: 'Toàn bộ thông báo hệ thống đã gửi, mới nhất trước.',
      sentLoading: 'Đang tải danh sách đã phát',
      sentLoadFailed: 'Không thể tải danh sách thông báo đã phát.',
      sentEmptyTitle: 'Chưa có thông báo nào được phát',
      sentEmptyDescription:
        'Thông báo bạn phát từ trang này sẽ xuất hiện tại đây.',
      sentHeaders: {
        title: 'Tiêu đề',
        type: 'Loại',
      ...
      sentPageSummary: '{count} thông báo',
      previousPage: 'Trang trước',
      nextPage: 'Trang sau',
      deleteLabel: 'Xoá thông báo',
      deleteConfirmTitle: 'Xoá thông báo đã phát?',
      deleteConfirmMessage:
        'Thông báo sẽ biến mất khỏi hộp thư của người nhận. Hành động này không thể hoàn tác.',
      deleteConfirm: 'Xoá',
      deleted: 'Đã xoá thông báo.',
      deleteFailed: 'Không xoá được thông báo.',
      roles: {
        STUDENT: 'Sinh viên',
        LECTURER: 'Giảng viên',
        ADMIN: 'Quản trị',
    ...
    attendance: {
      ...
      description:
        'Toàn bộ bản ghi điểm danh của các lớp học phần, trang mới nhất hiển thị trước.',
      loading: 'Đang tải bản ghi điểm danh',
      unavailableTitle: 'Điểm danh chưa sẵn sàng',
      errorDescription: 'Không tải được các bản ghi điểm danh. Vui lòng thử lại.',
      emptyTitle: 'Không có bản ghi điểm danh',
      emptyDescription:
        'Bản ghi sẽ xuất hiện khi giảng viên điểm danh cho các lớp của họ.',
      refresh: 'Làm mới',
      recordsCount: 'bản ghi',
      tableTitle: 'Bản ghi điểm danh',
  ...
  // LEC-P3-B2: discard confirm for the lecturer student-notice composer.
  lecturerAnnouncementDraft: {
    discardTitle: 'Bỏ bản nháp thông báo này?',
    discardMessage:
      'Thông báo chưa được đăng. Đóng ngay sẽ mất toàn bộ nội dung Thầy/Cô đã soạn trong khung soạn thảo.',
  ...
  thesis: {
    ...
    memberSearchPlaceholder: 'Mã số sinh viên hoặc họ tên...',
    ...
    maxMembersReached: 'Nhóm đã đạt số lượng tối đa 4 thành viên.',
    ...
    memberCount: '{count}/4 thành viên',
    ...
    progressDescription: 'Theo dõi các mốc có bằng chứng của đợt đã chọn.',
    progressCurrentStage: 'Giai đoạn hiện tại',
    progressGroupRequired: 'Hãy tạo hoặc tham gia nhóm để xem tiến độ gắn với nhóm.',
    progressAttention: 'Cần lưu ý',
    progressNotParticipating: 'Bạn không có nhóm trong đợt này. Lịch sử này không được suy diễn là đã hoàn tất.',
    progressResultNotAvailable: 'Đợt đã công bố nhưng chưa có kết quả cá nhân của bạn.',
    progressDataIntegrity: 'Nhóm phải có từ 3 đến 4 thành viên. Hãy bổ sung thành viên và chờ quản trị viên kiểm tra trước khi tiếp tục.',
    progressInconsistent: 'Có dữ liệu mốc sau nhưng thiếu điều kiện trước đó. Tiến độ chính thức dừng ở mốc đã xác minh cuối cùng; bộ phận luận văn cần kiểm tra hồ sơ.',
    progressGroupRejected: 'Nhóm của bạn bị từ chối. Hãy trao đổi với bộ phận luận văn để biết lý do.',
    progressGroupCancelled: 'Nhóm của bạn đã bị hủy và không tiếp tục trong đợt này.',
    progressReportedStatus: 'Trạng thái tự báo cáo',
    progressSteps: [
      'Đã chọn đợt',
      'Đã tạo nhóm',
      'Đã được gán đề tài',
    ...
    councils: {
      ...
      lecturerLoadFailed: 'Không tải được danh sách giảng viên nên ô chọn thành viên đang trống.',
      roleChair: 'Chủ tịch',
    ...
    admin: {
      ...
      topicsForRound: 'Đề tài thuộc đợt: {round}',
      groupsForRound: 'Nhóm thuộc đợt: {round}',
    },
  },
  assistant: {
    ...
    feedbackSaving: 'Đang lưu phản hồi…',
    feedbackSaveFailed: 'Phản hồi chưa được lưu. Lựa chọn đã lưu trước đó không thay đổi.',
    retryFeedback: 'Thử lưu lại',
  ...
  roundMilestone: {
    ...
    phase2Desc: 'Nhóm 3–4 SV chọn 1 đề tài (Điều R4)',
  ...
  attendance: {
    ...
    title: 'Điểm danh',
    description:
      'Điểm danh do giảng viên ghi nhận: tổng hợp theo môn học trước, sau đó là các phiên học gần nhất.',
    loading: 'Đang tải dữ liệu điểm danh',
    unavailableTitle: 'Chưa tải được dữ liệu điểm danh',
    errorDescription: 'Không tải được dữ liệu điểm danh. Vui lòng kiểm tra kết nối và thử lại.',
    emptyTitle: 'Chưa có bản ghi điểm danh',
    emptyDescription:
      'Khi giảng viên bắt đầu điểm danh cho các lớp của bạn, bảng tổng hợp theo môn và lịch sử phiên học sẽ xuất hiện tại đây.',
    statsPresentRate: 'Tỷ lệ có mặt',
    statsPresentRateHint: 'số phiên có mặt ÷ số phiên đã ghi',
    statsTotalSessions: 'Tổng số phiên đã ghi',
    statsPresent: 'Số phiên có mặt',
    statsAbsentLate: 'Vắng + đi muộn',
    byCourseTitle: 'Điểm danh theo môn học',
    byCourseEyebrow: 'Theo lớp học phần',
    recentTitle: 'Các phiên gần đây',
    recentEyebrow: 'Nhật ký phiên học',
    recentEmpty: 'Chưa có phiên học nào được ghi nhận.',
    showingRecent: 'Hiển thị {count} / {total} phiên đã ghi',
    tableHeaders: {
      course: 'Môn học',
      sessions: 'Số phiên',
      present: 'Có mặt',
  ...
  lecturerAttendance: {
    eyebrow: 'Khu vực giảng dạy',
    title: 'Điểm danh học phần',
    description: 'Theo dõi và điểm danh chuyên cần sinh viên theo từng lớp học phần và ngày học.',
    selectSection: 'Chọn lớp học phần',
    selectSemester: 'Chọn học kỳ',
    allSemesters: 'Tất cả học kỳ',
    dateLabel: 'Ngày điểm danh',
    markAllPresent: 'Đánh dấu tất cả có mặt',
    resetStatuses: 'Đặt lại',
    saveButton: 'Lưu điểm danh',
    savingButton: 'Đang lưu...',
    savedSuccess: 'Đã lưu điểm danh cho {count} sinh viên thành công',
    saveFailed: 'Không thể lưu điểm danh. Vui lòng thử lại.',
    noSectionsTitle: 'Chưa có lớp giảng dạy',
    noSectionsDescription: 'Hiện tại bạn chưa được phân công phụ trách lớp học phần nào.',
    noStudentsTitle: 'Lớp chưa có sinh viên',
    noStudentsDescription: 'Hiện chưa có sinh viên nào đăng ký vào lớp học phần này.',
    loadingSections: 'Đang tải danh sách lớp học phần...',
    loadingRoster: 'Đang tải danh sách sinh viên...',
    columnStudent: 'Sinh viên',
    columnStudentCode: 'Mã số SV',
    columnStatus: 'Trạng thái điểm danh',
    columnNotes: 'Ghi chú',
    notesPlaceholder: 'Lý do vắng hoặc ghi chú thêm (không bắt buộc)',
    statsTotalStudents: 'Tổng số sinh viên',
    statsMarked: 'Đã điểm danh hôm nay',
    statsPresentRate: 'Tỷ lệ chuyên cần',
    statuses: {
      PRESENT: 'Có mặt',
      ABSENT: 'Vắng',
      LATE: 'Đi muộn',
