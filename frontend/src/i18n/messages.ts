...
export const en = {
  ...
  signup: {
    eyebrow: 'Student account access',
    title: 'Your campus account is issued by the Academic Office.',
    description: 'Student identities are verified and provisioned by the campus academic office.',
    heading: 'Request an issued account',
    subheading: 'There is no public student self-registration form.',
    issuedByOfficeTitle: 'Why this is managed',
    issuedByOfficeDescription:
      'The Academic Office creates the student identity, student number, and initial campus access after verifying the official records.',
    issuedByOfficeSteps: [
      'Contact the Academic Office if you do not yet have campus credentials.',
      'Use the issued campus email and temporary password on the student sign-in page.',
      'Ask the Academic Office to correct your name or account details; students cannot rename themselves.',
    ],
    ...
    officeContact: 'Contact the Academic Office for issuance or account recovery.',
  ...
  thesis: {
    ...
    report: {
      ...
      fileHint: 'Upload a Word/PDF document (max 20 MB) or provide a link — at least one is required.',
...
export const vi: I18nMessages = {
  ...
  signup: {
    eyebrow: 'Truy cập tài khoản sinh viên',
    title: 'Tài khoản campus do Phòng Đào tạo cấp.',
    description: 'Danh tính sinh viên được nhà trường xác minh và cấp qua Phòng Đào tạo.',
    heading: 'Yêu cầu cấp tài khoản',
    subheading: 'Hệ thống không mở biểu mẫu tự đăng ký tài khoản sinh viên công khai.',
    issuedByOfficeTitle: 'Vì sao tài khoản được quản lý tập trung',
    issuedByOfficeDescription:
      'Phòng Đào tạo tạo danh tính sinh viên, mã số sinh viên và quyền truy cập ban đầu sau khi đối chiếu hồ sơ chính thức.',
    issuedByOfficeSteps: [
      'Liên hệ Phòng Đào tạo nếu bạn chưa có thông tin đăng nhập campus.',
      'Dùng email trường và mật khẩu tạm thời được cấp tại màn hình đăng nhập sinh viên.',
      'Liên hệ Phòng Đào tạo để chỉnh sửa họ tên hoặc thông tin tài khoản; sinh viên không thể tự đổi tên.',
    ],
    firstNameLabel: 'Tên',
    lastNameLabel: 'Họ',
    emailLabel: 'Địa chỉ email',
    ...
    officeContact: 'Liên hệ Phòng Đào tạo để được cấp hoặc khôi phục tài khoản.',
  ...
  thesis: {
    ...
    report: {
      ...
      fileHint: 'Nộp file Word/PDF (tối đa 20 MB) hoặc dán liên kết — cần ít nhất một.',
