...
export const thesisWorkflowEn = {
  ...
  page: {
    ...
    tabRepository: '3. Thesis & project repository',
    ...
    viewReportDocument: 'Download Report Artifact',
    openExternalLink: 'Open Submission Link',
    submittedAtLabel: 'Submitted:',
    lastUpdatedLabel: 'Updated:',
    archiveSupervisorLabel: 'Supervisor:',
    leaderLabel: 'Leader:',
    ...
    fileTypeLabel: 'Type:',
    reportNotesLabel: 'Notes / Abstract:',
...
export const thesisWorkflowVi: Widen<typeof thesisWorkflowEn> = {
  ...
  page: {
    ...
    tabRepository: '3. Kho lưu trữ luận án & báo cáo',
    ...
    viewReportDocument: 'Tải tài liệu báo cáo',
    openExternalLink: 'Mở liên kết nộp bài',
    submittedAtLabel: 'Thời gian nộp:',
    lastUpdatedLabel: 'Cập nhật:',
    archiveSupervisorLabel: 'GVHD:',
    leaderLabel: 'Trưởng nhóm:',
    membersLabel: 'Thành viên:',
    topicCodeLabel: 'Mã đề tài:',
    groupCodeLabel: 'Mã nhóm:',
    fileSizeLabel: 'Dung lượng:',
    fileTypeLabel: 'Định dạng:',
    reportNotesLabel: 'Ghi chú / Tóm tắt:',
