...
export default function AdminAnnouncementsPage() {
  ...
  const copy = vi
    ? {
        ...
        noFieldChange: 'Không có trường hiển thị nào thay đổi trong lần này.',
    ...
    : {
        title: 'Announcement governance',
        description: 'Edit, schedule, and archive announcements with a clear audit trail.',
        refresh: 'Refresh',
        ...
        noFieldChange: 'No visible fields changed in this entry.',
