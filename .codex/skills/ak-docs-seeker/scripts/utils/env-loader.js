 ...
 * Respects the active project adapter instead of assuming a provider folder.
 */

const fs = require('fs');
const path = require('path');
const { environmentPaths } = require(path.resolve(
  __dirname,
...
function loadEnv() {
  ...
  const envPaths = environmentPaths(skillDir);
