...
> Runtime scope: this reference documents the Claude Code plugin marketplace
> protocol. Codex projects should use `.codex-plugin/plugin.json` and the
> Codex personal marketplace flow instead; do not copy the Claude settings
> snippets below into `.codex` and assume they are equivalent.
