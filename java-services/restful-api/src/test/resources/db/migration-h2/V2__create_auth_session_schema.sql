...
CREATE INDEX IF NOT EXISTS auth_session_user_idx ON campuscore_auth."Session" ("userId");
CREATE INDEX IF NOT EXISTS auth_session_refresh_idx ON campuscore_auth."Session" ("refreshToken");
