...
CREATE INDEX IF NOT EXISTS academic_waitlist_student_idx ON academic."Waitlist" ("studentId", "status");
CREATE INDEX IF NOT EXISTS academic_waitlist_section_idx ON academic."Waitlist" ("sectionId", "status");
