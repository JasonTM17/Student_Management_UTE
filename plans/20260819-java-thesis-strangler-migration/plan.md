...
- Admin Users, Courses, and Classrooms now have bounded stacked mobile-card implementations with desktop-table fallbacks; the latest frontend smoke is 23/23, typecheck and lint pass, and the remaining dense admin tables are still open.
