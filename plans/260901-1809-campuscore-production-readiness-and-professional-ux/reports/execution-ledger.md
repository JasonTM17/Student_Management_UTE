...
Resume from the exact pushed `main` SHA `5d9eb3c5937365b6781b137ef597ac7bf0079bc7`: obtain the required independent review, run the deferred mobile-390 and fresh-registry gates, then dispatch publication only after the review/CI and secret prerequisites are satisfied. Do not touch the preserved dirty WIP worktrees or claim production cutover without VPS/domain/DNS/TLS evidence.
